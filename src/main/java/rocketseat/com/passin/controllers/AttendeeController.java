...
import rocketseat.com.passin.dto.attendee.AttendeeResponseBadgeDTO;
...
public class AttendeeController {
    ...
    public ResponseEntity<AttendeeResponseBadgeDTO> getAttendeeBadge(@PathVariable String attendeeId, UriComponentsBuilder uriComponentsBuilder){
        AttendeeResponseBadgeDTO response = this.attendeeService.getAttendeeBadge(
                attendeeId, uriComponentsBuilder
        );
